...
var gameState = PLAY;
var playMessage = "Arqueiro Épico!";
var winMessage = "Parabéns! Você ganhou!";
var gameOverMessage = "GAMEOVER! Tente novamente!";
...
function draw() {
  ...
  if(gameState === PLAY){
    ...
    textAlign("center");
    textSize(40);
    text(gameOverMessage, width / 2, 100);
  }
}
